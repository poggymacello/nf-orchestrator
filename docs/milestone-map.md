...
| **M4** | Observability + 3 failure drills + postmortems + runbooks | learning-notes/prometheus-instrumentation, operations/runbooks, operations/postmortems | code: `/metrics` done · drills 1–2 done, drill 3 blocked (kind disables disk eviction) · docs: in progress |
