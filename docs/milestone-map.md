...
| **M4** | Observability + failure drills + postmortems + runbooks | learning-notes/prometheus-instrumentation, operations/runbooks, operations/postmortems, ADR-0006 to ADR-0009 | code: `/metrics`, lifecycle and operation gauges, reconciler fixes, `/readyz`, repair route done · alert rules verified · **done** — 5 drills run, every defect fixed. The disk drill abandoned on day 11 ran on 2026-09-12 as [drill 5](operations/postmortems/2026-09-12-drill-5-disk-pressure-and-eviction.md), closing the last open action item |
